...
decision_tree <- train(Species~., data=train_data, method='rpart', 
                       trControl=control, metric=metric)
decision_tree
...
svm_model <- train(Species~., data=train_data, method='svmRadial', 
                 trControl=control, metric=metric)
svm_model

#Random Forest 
random_forest <- train(Species~., data=train_data, method='ranger', 
                trControl=control, metric=metric)
random_forest 
